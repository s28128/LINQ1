...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        /// </summary>
        public static IEnumerable Task4()
        {
            var result = Emps
                .Where(e => e.Salary == Emps.Max(ee => ee.Salary))
                .OrderBy(e => e.Mgr)
                .Select(e => new { Empno = e.Empno, Salary = e.Salary });
            return result;
        }
        ...
        {
            var result = Emps.Select(e => new { Nazwisko = e.Ename, Praca = e.Job }).ToList();
            return result;
        }
        ...
        {
            var result = Emps.GroupBy(e => e.Job).Select(g => new
            {
                Praca = g.Key,
                LiczbaPraconikow = g.Count()
            }).ToList();
            return result;
        }
        ...
        {
            var result = Emps.Where(e => e.Job == "Frontend programmer")
        ...
        {
            var result = Emps.Select(e => new { Ename = e.Ename, Job = e.Job, Hiredate = e.HireDate })
        ...
        {
            var result = Depts.Where(d =>
                    Emps.Count(e => e.Deptno == d.Deptno) == 5 || Emps.Count(e => e.Deptno == d.Deptno) == 0)
                .OrderBy(d => d.Dname);  
            return result;
        }
